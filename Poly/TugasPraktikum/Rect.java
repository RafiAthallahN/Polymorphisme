 ...
 */
public class Rect {
    // 4 variable utama yang menentukan titik sudut persegi panjang
    ...
    /*konstruktor dengan panjang dan lebar dimulai dari koordinat 0,0*/
    public Rect(int width, int height){
        this(0,0, width, height);
    }
    /*konstruktor persegi nol*/
    public Rect(){
        this(0,0,0,0);
    }
    
    /*method untuk menggeest persegi panjang*/
    public void move(int deltax, int deltay){
        x1 += deltax; x2+= deltax;
        y1 += deltay; y2+=deltay;
    }
    
    /*method untuk memerikasa apa suatu titik didalam persegi panjang*/
